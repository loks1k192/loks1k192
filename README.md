...
**МАИ, Прикладная математика и информатика** — *Бакалавриат (2 курс)*
> Фундаментальная база: алгоритмы, дискретная математика и системное программирование.
...
* **Хакатоны:** Финалист **Авиахакатона 2024** («Системный взлёт»). Проектировал backend-архитектуру для высоконагруженного кейса в условиях сжатых сроков.
