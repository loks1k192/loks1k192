...
* **Яндекс Практикум** — Backend-разработка на Python  
Стек: Python 3, Django, Django REST Framework, PostgreSQL, Docker, Git  
Темы: проектирование REST API, работа с БД через ORM, аутентификация и авторизация, тестирование, контейнеризация и деплой  
Практика: разработка backend-сервисов, API, финальный production-проект с код-ревью
* **Алгоритмы и структуры данных** — LeetCode / NeetCode 75 (Easy / Medium)  
* **Авиахакатон 2024 (Системный взлёт)** — Проектирование backend-архитектуры в команде  
