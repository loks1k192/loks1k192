...
**Python Backend Developer** 📍 Москва
...
* **Яндекс Практикум:** Специализированный курс по Backend-разработке на Python(Django, Docker).
* **Алгоритмическая подготовка:** Решение задач на LeetCode/NeetCode 75 (Easy/Medium).
* **Авиахакатон 2024(Системный взлет):** Проектирование архитектуры backend-составляющей сервиса в команде.
...
* **English:** B2 (Upper-intermediate), свободное чтение документации
