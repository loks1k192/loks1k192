...
Бакалавриат МАИ (ПМИ). Специализируюсь на Backend-разработке. Обладаю опытом работы с асинхронным программированием, проектированием API и инструментами DevOps
