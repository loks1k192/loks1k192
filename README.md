...
* **Яндекс Практикум:** Специализированный курс по Backend-разработке (Django, Docker).
* **Алгоритмическая подготовка:** Решение задач на LeetCode/NeetCode 75 (Easy/Medium).
* **Авиахакатон 2024:** Проектирование архитектуры backend-составляющей сервиса в команде.
