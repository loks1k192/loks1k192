...
**Технологии:** Python 3 · Django · Django REST Framework · PostgreSQL · Docker · Git  

**Ключевые темы:**  
- Проектирование и реализация REST API  
- Пабота с базами данных через Django ORM  
...
- Работа с Git и код-ревью  
- Финальный production-проект  

---

### **Алгоритмы и структуры данных**  
- LeetCode / NeetCode 75 — *Easy / Medium*

---

### **Авиахакатон 2024 — «Системный взлёт»**  
- Проектирование backend-архитектуры в команде
---
